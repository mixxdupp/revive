        ...
        TriageNode(id: "hurt-root", question: "What is the primary injury?", options: [
            ...
            TriageOption(id: "hurt-bleeding", label: "Bleeding (Severe)", icon: "drop.fill", destination: .nextQuestion(
                TriageNode(id: "hurt-bleed-q", question: "Is it life-threatening?", options: [
                    ...
                    TriageOption(id: "bleed-torso", label: "Chest / Abdomen / Neck", icon: "shield.fill", destination: .technique("firstaid-wound-packing")),
                            /* Injected */ TriageOption(id: "orphan-firstaid-8146", label: "Trauma (Expanded)", icon: "plus.circle.fill", destination: .techniqueList(["firstaid-flail-chest", "firstaid-pelvic-fracture", "firstaid-splint-basics", "firstaid-traumatic-amputation", "firstaid-tension-pneumo", "firstaid-knee-stabilization", "firstaid-femoral-pressure", "firstaid-sucking-chest-dressing", "firstaid-abdominal-evisceration", "firstaid-sucking-chest-seal"])), // Orphan
            ...
            TriageOption(id: "hurt-head", label: "Head / Eye / Mouth", icon: "brain.head.profile", destination: .nextQuestion(
                TriageNode(id: "hurt-head-q", question: "What is the issue?", options: [
                    ...
                    TriageOption(id: "head-tooth", label: "Toothache / Broken Tooth", icon: "mouth.fill", destination: .technique("firstaid-tooth-emergency")),
                            /* Injected */ TriageOption(id: "orphan-firstaid-1839", label: "Dental (Expanded)", icon: "plus.circle.fill", destination: .techniqueList(["firstaid-emergency-dental-kit"])), // Added orphan
            ...
            TriageOption(id: "hurt-choking-resp", label: "Choking Response Guide", icon: "person.fill.xmark", destination: .technique("firstaid-choking-response")),
                            /* Injected */ TriageOption(id: "orphan-firstaid-9319", label: "Airway (Expanded)", icon: "plus.circle.fill", destination: .techniqueList(["firstaid-cricothyrotomy-prep", "firstaid-choking-heimlich"])),
            ...
            TriageOption(id: "hurt-minor", label: "Minor / Surface Injury", icon: "bandage.fill", destination: .nextQuestion(
                TriageNode(id: "hurt-minor-q", question: "What happened?", options: [
                    ...
                    TriageOption(id: "minor-sprain", label: "Sprain / Twisted Joint", icon: "bandage.fill", destination: .technique("firstaid-sprain")),
                            /* Injected */ TriageOption(id: "orphan-firstaid-2975", label: "Musculoskeletal (Expanded)", icon: "plus.circle.fill", destination: .techniqueList(["firstaid-figure-8-bandage", "firstaid-cravat-sling"])),
            ...
            TriageOption(id: "hurt-transport", label: "Moving an Injured Person", icon: "figure.2.arms.open", destination: .nextQuestion(
                TriageNode(id: "hurt-transport-q", question: "What do you need?", options: [
                    ...
                    TriageOption(id: "transport-nerve", label: "Check Nerve / Circulation", icon: "waveform.path.ecg", destination: .technique("firstaid-nerve-assessment")),
                            /* Injected */ TriageOption(id: "orphan-firstaid-5780", label: "Assessment (Expanded)", icon: "plus.circle.fill", destination: .techniqueList(["firstaid-blood-pressure-field", "firstaid-abdominal-assessment", "firstaid-rectal-temp-assessment", "firstaid-rapid-trauma-survey", "firstaid-spine-clearing-field", "firstaid-primary-survey", "firstaid-secondary-survey", "firstaid-vital-signs"])),
            ...
            TriageOption(id: "hurt-psych", label: "Psychological Crisis", icon: "brain.head.profile", destination: .nextQuestion(
                TriageNode(id: "hurt-psych-q", question: "What's happening?", options: [
                    TriageOption(id: "psych-crisis-panic", label: "Panic Attack", icon: "wind", destination: .techniqueList(["psych-combat-breathing", "firstaid-hyperventilation"])),
                            /* Injected */ TriageOption(id: "orphan-psych-8718", label: "Stress Management (Expanded)", icon: "plus.circle.fill", destination: .techniqueList(["psych-acute-stress-mgmt", "psych-progressive-muscle-relaxation"])),
                ...
                TriageNode(id: "cold-env", question: "What environment are you in?", options: [
                    ...
                    TriageOption(id: "cold-forest", label: "Forest / Woodland", icon: "tree.fill", destination: .nextQuestion(
                        TriageNode(id: "cold-forest-mat", question: "What materials do you have?", options: [
                            ...
                            /* Injected */ TriageOption(id: "orphan-shelter-2878", label: "Tarp (Expanded)", icon: "plus.circle.fill", destination: .techniqueList(["shelter-tarp-plow-alt", "shelter-tarp-leanto-alt"])),
                            ...
                            /* Injected */ TriageOption(id: "orphan-shelter-6977", label: "Vehicle (Expanded)", icon: "plus.circle.fill", destination: .techniqueList(["shelter-vehicle-survival"])),
                            /* Injected */ TriageOption(id: "orphan-shelter-1043", label: "Clothing (Expanded)", icon: "plus.circle.fill", destination: .techniqueList(["shelter-improvised-poncho"])),
                            /* Injected */ TriageOption(id: "orphan-shelter-9984", label: "Desert (Expanded)", icon: "plus.circle.fill", destination: .techniqueList(["shelter-desert-trench-tarp", "shelter-desert-shade"])),
                            /* Injected */ TriageOption(id: "orphan-shelter-9637", label: "Forest (Expanded)", icon: "plus.circle.fill", destination: .techniqueList(["shelter-tree-house-platform", "shelter-hammock-improvised"])),
                            /* Injected */ TriageOption(id: "orphan-shelter-1343", label: "Concealment (Expanded)", icon: "plus.circle.fill", destination: .techniqueList(["shelter-spider-hole", "shelter-personal-camo"])),
                            /* Injected */ TriageOption(id: "orphan-shelter-3267", label: "Gear (Expanded)", icon: "plus.circle.fill", destination: .techniqueList(["shelter-poncho-tent"])),
                            /* Injected */ TriageOption(id: "orphan-shelter-9429", label: "Tarp & Poncho (Expanded)", icon: "plus.circle.fill", destination: .techniqueList(["shelter-poncho-configs"])),
                            
                            TriageOption(id: "cold-mylar", label: "Space Blanket / Trash Bag", icon: "sparkle", destination: .technique("shelter-mylar-wrap")),
                            /* Injected */ TriageOption(id: "orphan-shelter-4596", label: "Emergency (Expanded)", icon: "plus.circle.fill", destination: .techniqueList(["shelter-vehicle-alt", "shelter-emergency-trash-insulation", "shelter-brush-wall"]))
                        ])
                    )),
                        ...
                        TriageNode(id: "cold-snow-depth", question: "How deep is the snow?", options: [
                            TriageOption(id: "cold-snow-deep", label: "Waist-Deep or More", icon: "arrow.down.to.line", destination: .nextQuestion(
                                TriageNode(id: "cold-snow-tool", question: "Do you have a digging tool?", options: [
                                    ...
                                    TriageOption(id: "cold-snow-hands", label: "Bare Hands / Stick", icon: "hand.raised.fill", destination: .techniqueList(["shelter-snow-trench", "tools-digging-stick"])),
                            /* Injected */ TriageOption(id: "orphan-shelter-6838", label: "Winter (Expanded)", icon: "plus.circle.fill", destination: .techniqueList(["shelter-snow-cave-insulation"])) // Added orphan
                                ])
                            )),
                ...
                TriageNode(id: "cold-concern", question: "What's your main concern?", options: [
                    ...
                    TriageOption(id: "cold-need-fire", label: "Need to Start Fire", icon: "flame", destination: .nextQuestion(
                        TriageNode(id: "cold-fire-tools", question: "What fire tools do you have?", options: [
                            ...
                            /* Injected */ TriageOption(id: "orphan-fire-3374", label: "Solar (Expanded)", icon: "plus.circle.fill", destination: .techniqueList(["fire-fire-from-ice", "fire-magnifying-glass"])),
                                    TriageOption(id: "cold-sun-no", label: "No — Overcast/Night", icon: "cloud.fill", destination: .technique("fire-bowdrill")),
                            /* Injected */ TriageOption(id: "orphan-fire-5552", label: "Fire Carry (Expanded)", icon: "plus.circle.fill", destination: .techniqueList(["fire-coal-carry-fungus", "fire-slow-match", "fire-coal-extender"])),
                            /* Injected */ TriageOption(id: "orphan-fire-2541", label: "Electrical (Expanded)", icon: "plus.circle.fill", destination: .techniqueList(["fire-battery-steel-wool"])),
                            /* Injected */ TriageOption(id: "orphan-fire-4841", label: "Spark (Expanded)", icon: "plus.circle.fill", destination: .techniqueList(["fire-flint-steel-traditional"])),
                            /* Injected */ TriageOption(id: "orphan-fire-4588", label: "Friction (Expanded)", icon: "plus.circle.fill", destination: .techniqueList(["fire-pump-drill", "fire-fire-plough", "fire-two-person-bow-drill", "fire-fire-saw", "fire-hand-drill", "fire-bow-drill"]))
                                ])
                            )),
                            ...
                            /* Injected */ TriageOption(id: "orphan-fire-1228", label: "Structure (Expanded)", icon: "plus.circle.fill", destination: .techniqueList(["fire-underground-fire"])),
                            ...
                            /* Injected */ TriageOption(id: "orphan-fire-4303", label: "Ignition (Expanded)", icon: "plus.circle.fill", destination: .techniqueList(["fire-steel-wool-battery"]))
                        ])
                    )),
                    ...
                    TriageOption(id: "cold-hypothermia", label: "Signs of Hypothermia", icon: "thermometer.snowflake", destination: .nextQuestion(
                        TriageNode(id: "cold-hypo-who", question: "Who is affected?", options: [
                            ...
                            /* Injected */ TriageOption(id: "orphan-firstaid-2215", label: "Environmental (Expanded)", icon: "plus.circle.fill", destination: .techniqueList(["firstaid-heat-illness-spectrum", "firstaid-hypothermia-wrap", "firstaid-drowning-aftercare", "firstaid-chilblains", "firstaid-lightning-strike", "firstaid-water-purification-drops", "firstaid-hypothermia-active-warming", "firstaid-dehydration-response", "firstaid-heatstroke-response"])),
                    ...
                    TriageOption(id: "cold-morale", label: "Losing Hope / Morale", icon: "brain.head.profile", destination: .nextQuestion(
                        TriageNode(id: "cold-morale-q", question: "What do you need?", options: [
                            ...
                            /* Injected */ TriageOption(id: "orphan-psych-8437", label: "Planning (Expanded)", icon: "plus.circle.fill", destination: .techniqueList(["psych-survival-priorities"])),
                            /* Injected */ TriageOption(id: "orphan-psych-6418", label: "Leadership (Expanded)", icon: "plus.circle.fill", destination: .techniqueList(["psych-conflict-deescalation"])),
                            /* Injected */ TriageOption(id: "orphan-psych-2744", label: "Mental (Expanded)", icon: "plus.circle.fill", destination: .techniqueList(["psych-decision-fatigue-halt", "psych-sensory-deprivation", "psych-grief-triage", "psych-panic-stop-protocol", "psych-night-fear", "psych-will-to-survive"])),
                            /* Injected */ TriageOption(id: "orphan-psych-3227", label: "Mindset (Expanded)", icon: "plus.circle.fill", destination: .techniqueList(["psych-solo-pep-talk", "psych-survival-priorities-recitation"])),
                    ...
                    TriageOption(id: "cold-improve", label: "Improve Existing Shelter", icon: "wrench.fill", destination: .nextQuestion(
                        TriageNode(id: "cold-improve-q", question: "What improvement?", options: [
                            ...
                            /* Injected */ TriageOption(id: "orphan-shelter-1607", label: "General (Expanded)", icon: "plus.circle.fill", destination: .techniqueList(["shelter-drainage-system", "shelter-wind-assessment", "shelter-rainwater-diversion", "shelter-door-insulation", "shelter-site-drainage-check", "shelter-bedding-layers"])),
                    ...
                    TriageOption(id: "cold-arctic-travel", label: "Need to Travel in Cold", icon: "figure.walk", destination: .nextQuestion(
                        TriageNode(id: "cold-travel-q", question: "What terrain?", options: [
                            ...
                            /* Injected */ TriageOption(id: "orphan-tools-1857", label: "Protective Gear (Expanded)", icon: "plus.circle.fill", destination: .techniqueList(["tools-improvised-goggles"]))
                        ])
                    ))
                ])
            )),
    ...
    private func buildFireTriage() -> TriageNode {
        TriageNode(id: "fire-root", question: "What fire-starting tools do you have?", options: [
                ...
                TriageNode(id: "fire-cond", question: "Do you have a kit?", options: [
                    ...
                    TriageOption(id: "fire-kit-no", label: "No — Standard Lighter", icon: "flame", destination: .nextQuestion(
                        TriageNode(id: "fire-standard-cond", question: "Current Conditions?", options: [
                            ...
                            /* Injected */ TriageOption(id: "orphan-rescue-9086", label: "Maritime (Expanded)", icon: "plus.circle.fill", destination: .techniqueList(["rescue-man-overboard"])),
                            /* Injected */ TriageOption(id: "orphan-rescue-2246", label: "Signaling & Comm (Expanded)", icon: "plus.circle.fill", destination: .techniqueList(["rescue-signal-epirb-activation", "rescue-signal-plb-registration", "rescue-signal-sart-operation", "rescue-signal-vhf-channel-16", "rescue-signal-dsc-distress", "rescue-signal-flares-solas-vs-coast-guard", "rescue-signal-v-sheet-deployment", "rescue-signal-signal-mirror-heliograph", "rescue-signal-strobe-lights", "rescue-signal-dye-marker-strategies", "rescue-signal-smoke-canisters", "rescue-signal-radar-reflectors", "rescue-signal-sound-signals", "rescue-signal-arm-signals", "rescue-signal-inverted-ensign", "rescue-signal-fire-on-deck", "rescue-signal-sos-flashlight", "rescue-signal-whistle-blasts", "rescue-signal-ground-to-air-panel", "rescue-signal-helicopter-hoist-prep"])),
                            /* Injected */ TriageOption(id: "orphan-rescue-4147", label: "Signaling (Expanded)", icon: "plus.circle.fill", destination: .techniqueList(["rescue-sea-dye", "rescue-aerial-flare", "rescue-ground-air-symbols"])),
                            /* Injected */ TriageOption(id: "orphan-rescue-5761", label: "Signal (Expanded)", icon: "plus.circle.fill", destination: .techniqueList(["rescue-body-signals", "rescue-tire-fire-smoke", "rescue-night-light-signals", "rescue-attention-panel", "rescue-sos-signal-fire"])),
                ...
                TriageNode(id: "fire-ferro-tinder", question: "Do you have good tinder?", options: [
                    ...
                    TriageOption(id: "fire-ferro-none", label: "No Tinder Available", icon: "xmark.circle.fill", destination: .nextQuestion(
                        TriageNode(id: "fire-tinder-make", question: "Can you make tinder?", options: [
                            ...
                            /* Injected */ TriageOption(id: "orphan-fire-2000", label: "Preparation (Expanded)", icon: "plus.circle.fill", destination: .techniqueList(["fire-resin-collection", "fire-char-material", "fire-wet-wood-processing", "fire-birch-bark-uses", "fire-char-cloth"])),
                            ...
                            /* Injected */ TriageOption(id: "orphan-fire-6350", label: "Maintenance (Expanded)", icon: "plus.circle.fill", destination: .techniqueList(["fire-rain-fire-management", "fire-fire-safety-camp", "fire-fire-bundle-carry", "fire-night-fire-management"]))
                        ])
                    ))
                ])
            )),
            ...
            TriageOption(id: "fire-battery", label: "Battery + Steel Wool / Gum Wrapper", icon: "battery.75percent", destination: .technique("fire-battery")),
                            /* Injected */ TriageOption(id: "orphan-fire-6970", label: "Chemical (Expanded)", icon: "plus.circle.fill", destination: .techniqueList(["fire-chemical-permanganate", "fire-chemical-brake-fluid"])),
        ...
        TriageNode(id: "water-root", question: "What environment are you in?", options: [
                ...
                TriageNode(id: "water-flow-q", question: "Is the water moving?", options: [
                    TriageOption(id: "water-flow-yes", label: "Yes — Flowing Stream", icon: "water.waves", destination: .nextQuestion(
                        ...
                        TriageNode(id: "water-purify", question: "How can you purify it?", options: [
                            ...
                            /* Injected */ TriageOption(id: "orphan-water-2582", label: "Collection (Expanded)", icon: "plus.circle.fill", destination: .techniqueList(["water-gypsy-well", "water-solar-still-pit", "water-agave-cactus-safe", "water-tree-tapping-birch"])),
                            /* Injected */ TriageOption(id: "orphan-water-7170", label: "Purification (Expanded)", icon: "plus.circle.fill", destination: .techniqueList(["water-cloth-filtration", "water-ceramic-filter-build", "water-uv-sun-purification", "water-water-testing-field", "water-double-boil-purification", "water-boil-rock-wood", "water-uv-sodis", "water-charcoal-filter-diy", "water-seawater-distillation", "water-iodine-purification", "water-bleach-purification"])),
                            ...
                            /* Injected */ TriageOption(id: "orphan-tools-2549", label: "Container (Expanded)", icon: "plus.circle.fill", destination: .techniqueList(["tools-coconut-shell-bowl"]))
                                ])
                            )),
            ...
            TriageOption(id: "water-desert", label: "Desert / Arid Land", icon: "sun.max.fill", destination: .nextQuestion(
                TriageNode(id: "water-desert-q", question: "What resources are available?", options: [
                    TriageOption(id: "water-barren", label: "Nothing — Barren", icon: "xmark.circle.fill", destination: .techniqueList(["water-solar-still", "water-well-digging"])),
                            /* Injected */ TriageOption(id: "orphan-water-286", label: "Finding Water (Expanded)", icon: "plus.circle.fill", destination: .techniqueList(["water-sap-hydration", "water-beach-well", "water-dew-trap", "water-seep-improvement", "water-rock-catchment", "water-maple-birch-tapping", "water-rain-tarp-mega", "water-fog-fence", "water-vehicle-water-sources", "water-banana-leaf-funnel", "water-ice-melting-technique", "water-natural-spring-signs"])),
            ...
            TriageOption(id: "water-urban", label: "Urban Area", icon: "building.2.fill", destination: .nextQuestion(
                TriageNode(id: "water-urban-q", question: "What sources exist?", options: [
                    ...
                    TriageOption(id: "water-urban-store", label: "Need to Store / Ration", icon: "drop.fill", destination: .technique("water-storage")),
                            /* Injected */ TriageOption(id: "orphan-water-2300", label: "Storage (Expanded)", icon: "plus.circle.fill", destination: .techniqueList(["water-rationing-schedule", "water-condom-canteen-technique", "water-bamboo-segment-storage"]))
                ])
            )),
            ...
            TriageOption(id: "lost-just", label: "Just Now", icon: "exclamationmark.circle", destination: .nextQuestion(
                TriageNode(id: "lost-stop", question: "STOP. Do not move. Can you backtrack?", options: [
                    TriageOption(id: "lost-backtrack", label: "Yes — Remember the Way", icon: "arrow.uturn.left", destination: .technique("nav-lost-procedure")),
                            /* Injected */ TriageOption(id: "orphan-nav-4596", label: "Emergency (Expanded)", icon: "plus.circle.fill", destination: .techniqueList(["nav-creek-following", "nav-night-horizon-glow", "nav-river-crossing-technique", "nav-improvising-compass-needle"])),
                    TriageOption(id: "lost-unsure", label: "Not Sure / Disoriented", icon: "questionmark.circle.fill", destination: .nextQuestion(
                        TriageNode(id: "lost-tools", question: "What navigation tools do you have?", options: [
                            ...
                            /* Injected */ TriageOption(id: "orphan-nav-6187", label: "Basic Tools (Expanded)", icon: "plus.circle.fill", destination: .techniqueList(["nav-watch-method-southern"])),
                                            ...
                                            TriageOption(id: "lost-overcast", label: "Overcast / Can't See Sun", icon: "cloud.fill", destination: .techniqueList(["nav-natural-indicators", "nav-vegetation-indicators", "nav-wind-reading", "nav-cloud-reading"])),
                            /* Injected */ TriageOption(id: "orphan-nav-3198", label: "Natural (Expanded)", icon: "plus.circle.fill", destination: .techniqueList(["nav-wind-direction-feel", "nav-cloud-type-identification", "nav-insect-behavior", "nav-animal-trail-following", "nav-lichen-growth", "nav-bird-flight-patterns", "nav-pressure-detection", "nav-tree-growth-rings"])) // Added orphans
                                        ])
                                    )),
                            ...
                            /* Injected */ TriageOption(id: "orphan-nav-4190", label: "Advanced (Expanded)", icon: "plus.circle.fill", destination: .techniqueList(["nav-terrain-assoc-nav"])), // Added orphan
                ...
                TriageNode(id: "lost-strategy", question: "What's your plan?", options: [
                    TriageOption(id: "lost-stay", label: "Stay Put & Signal for Rescue", icon: "hand.raised.fill", destination: .nextQuestion(
                        TriageNode(id: "lost-signal-q", question: "What signaling tools do you have?", options: [
                            ...
                            TriageOption(id: "lost-sig-whistle", label: "Whistle / Loud Voice", icon: "speaker.wave.3.fill", destination: .techniqueList(["rescue-whistle", "rescue-whistle-patterns"])),
                            /* Injected */ TriageOption(id: "orphan-rescue-8615", label: "Audio Signaling (Expanded)", icon: "plus.circle.fill", destination: .techniqueList(["rescue-horn-whistle-pattern"])), // Added orphan
                    ...
                    TriageOption(id: "lost-walk", label: "Self-Rescue / Walk Out", icon: "figure.walk", destination: .nextQuestion(
                        TriageNode(id: "lost-walk-q", question: "Can you see or hear any landmark?", options: [
                            ...
                            TriageOption(id: "lost-urban-mark", label: "In Urban Area", icon: "building.2.fill", destination: .technique("rescue-urban-marking")),
                            /* Injected */ TriageOption(id: "orphan-rescue-3276", label: "Communication (Expanded)", icon: "plus.circle.fill", destination: .techniqueList(["rescue-cell-phone-emergency"])), // Added orphan
            ...
            TriageOption(id: "lost-env-nav", label: "Navigate by Environment", icon: "map.fill", destination: .nextQuestion(
                TriageNode(id: "lost-env-q", question: "What terrain are you in?", options: [
                    TriageOption(id: "lost-nav-coastal", label: "Coastal / Shoreline", icon: "water.waves", destination: .techniqueList(["nav-coastal", "nav-coastal-navigation"])),
                            /* Injected */ TriageOption(id: "orphan-nav-9086", label: "Maritime (Expanded)", icon: "plus.circle.fill", destination: .techniqueList(["nav-ocean-swel-reading"])),
            ...
            TriageOption(id: "lost-adv-compass", label: "Advanced Compass Skills", icon: "safari.fill", destination: .nextQuestion(
                TriageNode(id: "lost-adv-q", question: "What do you need?", options: [
                    ...
                    TriageOption(id: "lost-shadow-tip", label: "Shadow Tip Compass", icon: "sun.min.fill", destination: .technique("nav-shadow-tip-compass")),
                            /* Injected */ TriageOption(id: "orphan-nav-7943", label: "Celestial (Expanded)", icon: "plus.circle.fill", destination: .techniqueList(["nav-watch-compass-method", "nav-stars-orion", "nav-stars-southern-cross-adv", "nav-moon-phase-direction", "nav-stars-cassiopeia", "nav-stars-polaris-dipper", "nav-stars-southern-cross", "nav-moon-horn-method"])),
                ...
                TriageNode(id: "trapped-block", question: "What's preventing rescue?", options: [
                    ...
                    TriageOption(id: "trapped-terrain", label: "Terrain Blocked", icon: "mountain.2.fill", destination: .nextQuestion(
                        TriageNode(id: "trapped-terrain-q", question: "What's blocking you?", options: [
                            ...
                            /* Injected */ TriageOption(id: "orphan-rescue-4237", label: "Self-Rescue (Expanded)", icon: "plus.circle.fill", destination: .techniqueList(["rescue-self-evacuation-litter"])),
                ...
                TriageNode(id: "trapped-immobile", question: "What's the situation?", options: [
                    ...
                    TriageOption(id: "trapped-injured", label: "Injured — Need First Aid", icon: "cross.case.fill", destination: .nextQuestion(
                        TriageNode(id: "trapped-injury", question: "What type of injury?", options: [
                            ...
                            /* Injected */ TriageOption(id: "orphan-firstaid-9043", label: "Medical (Expanded)", icon: "plus.circle.fill", destination: .techniqueList(["firstaid-dental-field-fix", "firstaid-overdose-response", "firstaid-asthma-attack", "firstaid-eye-irrigation", "firstaid-seizure-response", "firstaid-foreign-body-ear", "firstaid-eye-patch-technique", "firstaid-chest-compressions-only-cpr", "firstaid-trench-foot-adv", "firstaid-choking-complete", "firstaid-eye-field"])),
                            ...
                            /* Injected */ TriageOption(id: "orphan-firstaid-4848", label: "Toxicology (Expanded)", icon: "plus.circle.fill", destination: .techniqueList(["firstaid-charcoal-ingestion"])),
                            /* Injected */ TriageOption(id: "orphan-firstaid-7544", label: "Natural Medicine (Expanded)", icon: "plus.circle.fill", destination: .techniqueList(["firstaid-willow-bark", "firstaid-plantain-poultice", "firstaid-honey-wound", "firstaid-garlic-antibiotic"])),
                            /* Injected */ TriageOption(id: "orphan-firstaid-5345", label: "Spine (Expanded)", icon: "plus.circle.fill", destination: .techniqueList(["firstaid-log-roll", "firstaid-cervical-collar"])),
                            /* Injected */ TriageOption(id: "orphan-firstaid-4725", label: "Marine Injury (Expanded)", icon: "plus.circle.fill", destination: .techniqueList(["firstaid-sea-urchin"])),
                            /* Injected */ TriageOption(id: "orphan-firstaid-2893", label: "Marine Envenomation (Expanded)", icon: "plus.circle.fill", destination: .techniqueList(["firstaid-cone-snail", "firstaid-blue-ring-octopus"])),
                            /* Injected */ TriageOption(id: "orphan-firstaid-5325", label: "Envenomation (Expanded)", icon: "plus.circle.fill", destination: .techniqueList(["firstaid-scorpion-sting", "firstaid-centipede-bite"])),
                            /* Injected */ TriageOption(id: "orphan-firstaid-8126", label: "Aquatic (Expanded)", icon: "plus.circle.fill", destination: .techniqueList(["firstaid-cold-water-immersion"])),
                            /* Injected */ TriageOption(id: "orphan-firstaid-5247", label: "Circulation (Expanded)", icon: "plus.circle.fill", destination: .techniqueList(["firstaid-shock-treatment"])),
                            /* Injected */ TriageOption(id: "orphan-firstaid-7276", label: "Cold Injury (Expanded)", icon: "plus.circle.fill", destination: .techniqueList(["firstaid-frostbite-rewarm"])),
                            /* Injected */ TriageOption(id: "orphan-firstaid-2737", label: "Eyes (Expanded)", icon: "plus.circle.fill", destination: .techniqueList(["firstaid-snow-blindness"])),
                            /* Injected */ TriageOption(id: "orphan-firstaid-6981", label: "Tropical Medicine (Expanded)", icon: "plus.circle.fill", destination: .techniqueList(["firstaid-leech-removal"])),
                            /* Injected */ TriageOption(id: "orphan-firstaid-3629", label: "Allergy (Expanded)", icon: "plus.circle.fill", destination: .techniqueList(["firstaid-allergic-mild"])),
                            /* Injected */ TriageOption(id: "orphan-firstaid-798", label: "Cardiac (Expanded)", icon: "plus.circle.fill", destination: .techniqueList(["firstaid-chest-cpr"])),
                            /* Injected */ TriageOption(id: "orphan-firstaid-2017", label: "Prevention (Expanded)", icon: "plus.circle.fill", destination: .techniqueList(["firstaid-insect-repellent-natural"])),
                            /* Injected */ TriageOption(id: "orphan-firstaid-3775", label: "Hygiene (Expanded)", icon: "plus.circle.fill", destination: .techniqueList(["firstaid-field-hygiene", "firstaid-field-sanitation-latrine"])),
                            /* Injected */ TriageOption(id: "orphan-firstaid-2980", label: "Hemorrhage (Expanded)", icon: "plus.circle.fill", destination: .techniqueList(["firstaid-tourniquet-field", "firstaid-nosebleed-field"])),
                            /* Injected */ TriageOption(id: "orphan-firstaid-8267", label: "Altitude (Expanded)", icon: "plus.circle.fill", destination: .techniqueList(["firstaid-altitude-sickness-ams", "firstaid-altitude-hace", "firstaid-altitude-hape"])),
                            /* Injected */ TriageOption(id: "orphan-firstaid-9546", label: "Marine Bites (Expanded)", icon: "plus.circle.fill", destination: .techniqueList(["firstaid-stingray-hot-water", "firstaid-jellyfish-vinegar"])),
                            /* Injected */ TriageOption(id: "orphan-firstaid-5908", label: "Orthopedic (Expanded)", icon: "plus.circle.fill", destination: .techniqueList(["firstaid-improvised-sam-splint", "firstaid-dislocated-shoulder"])),
                            /* Injected */ TriageOption(id: "orphan-firstaid-9125", label: "Wounds (Expanded)", icon: "plus.circle.fill", destination: .techniqueList(["firstaid-wound-irrigation", "firstaid-infection-signs", "firstaid-nail-bed-injury", "firstaid-field-sutures", "firstaid-infection-prevention-field", "firstaid-blood-clotting-agents", "firstaid-fishhook-string-yank", "firstaid-wound-closure-strips"])),
                            /* Injected */ TriageOption(id: "orphan-firstaid-3239", label: "Psychological (Expanded)", icon: "plus.circle.fill", destination: .techniqueList(["firstaid-panic-attack"]))
                                                ])
                                            )),
                    ...
                    TriageOption(id: "trapped-pinned", label: "Physically Trapped / Pinned", icon: "rectangle.compress.vertical", destination: .nextQuestion(
                        TriageNode(id: "trapped-pinned-q", question: "Can you attract attention?", options: [
                            ...
                            /* Injected */ TriageOption(id: "orphan-rescue-6819", label: "Technology (Expanded)", icon: "plus.circle.fill", destination: .techniqueList(["rescue-cell-phone-strategy", "rescue-plb-activation"])),
                    ...
                    TriageOption(id: "trapped-waiting", label: "Safe — Waiting for Rescue", icon: "clock.fill", destination: .nextQuestion(
                        TriageNode(id: "trapped-needs", question: "What do you need most?", options: [
                            ...
                            /* Injected */ TriageOption(id: "orphan-food-7778", label: "Insects (Expanded)", icon: "plus.circle.fill", destination: .techniqueList(["food-edible-insect-guide"])),
                            TriageOption(id: "trapped-need-morale", label: "Staying Calm / Morale", icon: "brain.head.profile", destination: .techniqueList(["psych-box-breathing", "psych-54321-grounding", "psych-routine", "psych-loneliness", "psych-ooda-loop", "psych-group-leadership", "psych-grief-processing", "psych-gratitude-practice", "psych-positive-self-talk"])),
                            /* Injected */ TriageOption(id: "orphan-psych-9372", label: "Emotional Management (Expanded)", icon: "plus.circle.fill", destination: .techniqueList(["psych-fear-vs-panic"])),
                            /* Injected */ TriageOption(id: "orphan-psych-103", label: "Resilience (Expanded)", icon: "plus.circle.fill", destination: .techniqueList(["psych-trauma-response-phases", "psych-hope-anchoring", "psych-survivor-guilt-management"])),
                            /* Injected */ TriageOption(id: "orphan-psych-5799", label: "Group (Expanded)", icon: "plus.circle.fill", destination: .techniqueList(["psych-children-manage", "psych-team-morale-games", "psych-leadership-survival"])), // Added orphans
                            ...
                            /* Injected */ TriageOption(id: "orphan-tools-3212", label: "Camp (Expanded)", icon: "plus.circle.fill", destination: .techniqueList(["tools-dakota-fire-hole"])),
                            /* Injected */ TriageOption(id: "orphan-tools-863", label: "Primitive (Expanded)", icon: "plus.circle.fill", destination: .techniqueList(["tools-fire-hardening", "tools-pitch-glue"])),
                            /* Injected */ TriageOption(id: "orphan-tools-233", label: "Adhesives (Expanded)", icon: "plus.circle.fill", destination: .techniqueList(["tools-natural-adhesive"])),
                            /* Injected */ TriageOption(id: "orphan-tools-317", label: "Containers (Expanded)", icon: "plus.circle.fill", destination: .techniqueList(["tools-gourd-canteen", "tools-birch-bark-basket"])),
                            /* Injected */ TriageOption(id: "orphan-tools-8240", label: "Weapons (Expanded)", icon: "plus.circle.fill", destination: .techniqueList(["tools-toggle-harpoon", "tools-bola", "tools-sling-weapon"])),
                            /* Injected */ TriageOption(id: "orphan-tools-725", label: "Trapping (Expanded)", icon: "plus.circle.fill", destination: .techniqueList(["tools-basket-fish-trap"])) // Added orphans
                        ])
                    )),
                ...
                TriageNode(id: "trapped-psych-q", question: "What do you need?", options: [
                    ...
                    TriageOption(id: "tp-sleep", label: "Sleep Management", icon: "moon.fill", destination: .nextQuestion(
                        TriageNode(id: "tp-sleep-q", question: "What's the issue?", options: [
                            ...
                            /* Injected */ TriageOption(id: "orphan-psych-9585", label: "Physical-Mental (Expanded)", icon: "plus.circle.fill", destination: .techniqueList(["psych-sleep-deprivation-coping"])),
                    ...
                    TriageOption(id: "tp-group", label: "Group Dynamics", icon: "person.3.fill", destination: .nextQuestion(
                        TriageNode(id: "tp-group-q", question: "What's happening?", options: [
                            ...
                            /* Injected */ TriageOption(id: "orphan-psych-2370", label: "Morale (Expanded)", icon: "plus.circle.fill", destination: .techniqueList(["psych-morale-food-psychology"]))
                        ])
                    )),
                    TriageOption(id: "tp-morale", label: "Building Morale", icon: "heart.fill", destination: .nextQuestion(
                        TriageNode(id: "tp-morale-q", question: "What technique?", options: [
                            ...
                            /* Injected */ TriageOption(id: "orphan-psych-3386", label: "Mental Resilience (Expanded)", icon: "plus.circle.fill", destination: .techniqueList(["psych-decision-mgmt", "psych-meditation-breathing", "psych-night-anxiety-mgmt", "psych-sensory-deprivation-mgmt"])),
                            ...
                            /* Injected */ TriageOption(id: "orphan-psych-8316", label: "Group Dynamics (Expanded)", icon: "plus.circle.fill", destination: .techniqueList(["psych-group-conflict"])),
            ...
            TriageOption(id: "trapped-tools", label: "Craft Tools & Equipment", icon: "wrench.and.screwdriver.fill", destination: .nextQuestion(
                TriageNode(id: "trapped-tools-q", question: "What do you need to make?", options: [
                    ...
                    TriageOption(id: "tool-cordage-opt", label: "Make Cordage / Rope", icon: "line.diagonal", destination: .technique("tools-cordage")),
                            /* Injected */ TriageOption(id: "orphan-tools-9888", label: "Craft (Expanded)", icon: "plus.circle.fill", destination: .techniqueList(["tools-bone-awl", "tools-shell-scraper", "tools-fire-hardened-digging-stick", "tools-weaving-basics", "tools-antler-tool", "tools-emergency-rope", "tools-fish-scaler-tool", "tools-bone-needle-craft"])),
                    ...
                    TriageOption(id: "tool-bone", label: "Bone & Natural Craft", icon: "leaf.fill", destination: .nextQuestion(
                        TriageNode(id: "tool-bone-q", question: "What to make?", options: [
                            ...
                            /* Injected */ TriageOption(id: "orphan-tools-9913", label: "Cutting Tools (Expanded)", icon: "plus.circle.fill", destination: .techniqueList(["tools-bamboo-knife"])),
            ...
            TriageOption(id: "dis-unrest", label: "Civil Unrest / Riots", icon: "person.3.fill", destination: .nextQuestion(
                TriageNode(id: "dis-unrest-q", question: "Your situation?", options: [
                    ...
                    TriageOption(id: "unrest-move", label: "Need to Move / Evade", icon: "figure.walk", destination: .techniqueList(["env-urban-grayman", "env-anti-tracking", "env-vehicle-entry"])),
                            /* Injected */ TriageOption(id: "orphan-env-1747", label: "Evasion (Expanded)", icon: "plus.circle.fill", destination: .techniqueList(["env-evasion-movement-night", "env-evasion-tracker-confusion", "env-evasion-face-paint", "env-evasion-dog-evasion", "env-evasion-checkpoint"])),
        ...
        TriageNode(id: "food-root", question: "What is your immediate situation?", options: [
                ...
                TriageNode(id: "food-starve-q", question: "How long without food?", options: [
                    TriageOption(id: "food-days-3", label: "1-3 Days", icon: "clock", destination: .nextQuestion(
                        TriageNode(id: "food-days3-q", question: "What can you do right now?", options: [
                            ...
                            /* Injected */ TriageOption(id: "orphan-food-1213", label: "Tropical Foraging (Expanded)", icon: "plus.circle.fill", destination: .techniqueList(["food-palm-heart", "food-coconut-water-safety"])),
                            /* Injected */ TriageOption(id: "orphan-food-8126", label: "Aquatic (Expanded)", icon: "plus.circle.fill", destination: .techniqueList(["food-crayfish-catching"])),
                            /* Injected */ TriageOption(id: "orphan-food-455", label: "Entomophagy (Expanded)", icon: "plus.circle.fill", destination: .techniqueList(["food-grub-eating"])),
                            /* Injected */ TriageOption(id: "orphan-food-8924", label: "Toxic Plant (Expanded)", icon: "plus.circle.fill", destination: .techniqueList(["food-botany-water-hemlock", "food-botany-poison-hemlock", "food-botany-death-camas", "food-botany-castor-bean", "food-botany-oleander", "food-botany-white-snakeroot", "food-botany-nightshade-deadly"])),
                            /* Injected */ TriageOption(id: "orphan-food-920", label: "Tracking (Expanded)", icon: "plus.circle.fill", destination: .techniqueList(["food-track-deer-tracks", "food-track-elk-tracks", "food-track-moose-tracks", "food-track-rabbit-tracks", "food-track-squirrel-tracks", "food-track-raccoon-tracks", "food-track-opossum-tracks", "food-track-beaver-tracks", "food-track-bear-tracks", "food-track-cougar-mountain-lion-tracks", "food-track-bobcat-tracks", "food-track-coyote-tracks", "food-track-wolf-tracks", "food-track-fox-tracks", "food-track-wild-boar-tracks", "food-track-turkey-tracks", "food-track-pheasant-tracks", "food-track-duck-tracks", "food-track-porcupine-tracks", "food-track-skunk-tracks"])),
                            /* Injected */ TriageOption(id: "orphan-food-6115", label: "Traps (Expanded)", icon: "plus.circle.fill", destination: .techniqueList(["food-trap-paiute", "food-trap-arapuca", "food-trap-spring-pole", "food-squirrel-pole"])),
                ...
                TriageNode(id: "food-forage-type", question: "What's available?", options: [
                    ...
                    TriageOption(id: "food-mushrooms", label: "Mushrooms", icon: "umbrella.fill", destination: .nextQuestion(
                        TriageNode(id: "food-shroom-safety", question: "Are you an expert?", options: [
                            ...
                            /* Injected */ TriageOption(id: "orphan-food-8639", label: "Foraging (Expanded)", icon: "plus.circle.fill", destination: .techniqueList(["food-pine-cambium", "food-clover-identification", "food-rose-hip-tea", "food-plantain-wild", "food-sap-collection", "food-nettle-harvest", "food-mushroom-rules", "food-seaweed-foraging", "food-wild-rice-harvest", "food-wild-yam-potato", "food-plant-pine-cambium", "food-plantain-weed", "food-cattail-tubers", "food-purslane-foraging", "food-botany-amaranth", "food-botany-asparagus-wild", "food-botany-burdock", "food-botany-chicory", "food-botany-chickweed", "food-botany-garlic-mustard", "food-botany-jerusalem-artichoke", "food-botany-lambsquarters", "food-botany-mallow", "food-botany-miners-lettuce", "food-botany-mustard-wild", "food-botany-onion-wild", "food-botany-pennycress", "food-botany-pigweed", "food-botany-shepherds-purse", "food-botany-sorrel-wood", "food-botany-sow-thistle", "food-botany-watercress", "food-botany-wintercress", "food-botany-yarrow", "food-botany-foxglove", "food-botany-monkshood", "food-botany-jimsonweed", "food-dandelion-full"])),
            ...
            TriageOption(id: "food-hunt", label: "Hunting & Trapping", icon: "hare.fill", destination: .nextQuestion(
                TriageNode(id: "food-hunt-method", question: "What method?", options: [
                    ...
                    TriageOption(id: "food-spear", label: "Spear Hunting", icon: "pencil.line", destination: .technique("food-fish-spear")),
                            /* Injected */ TriageOption(id: "orphan-food-8201", label: "Fish (Expanded)", icon: "plus.circle.fill", destination: .techniqueList(["food-crayfish-by-hand"])),
            ...
            TriageOption(id: "food-fish", label: "Fishing", icon: "fish.fill", destination: .nextQuestion(
                TriageNode(id: "food-fish-q", question: "What gear do you have?", options: [
                    ...
                    TriageOption(id: "food-crayfish-trap", label: "Crayfish / Crawdad Trap", icon: "circle.grid.cross.fill", destination: .technique("food-crayfish-trap")),
                            /* Injected */ TriageOption(id: "orphan-food-8411", label: "Fishing (Expanded)", icon: "plus.circle.fill", destination: .techniqueList(["food-gill-net", "food-trotline-fishing", "food-hand-fishing", "food-bait-collection", "food-fish-weir"])), // Added orphan
                ...
                TriageNode(id: "food-prep-q", question: "What do you need to do?", options: [
                    ...
                    TriageOption(id: "food-clean-game", label: "Skin / Gut Small Game", icon: "hare.fill", destination: .nextQuestion(
                        TriageNode(id: "food-clean-game-q", question: "What type of game?", options: [
                            TriageOption(id: "food-clean-game-gen", label: "General Cleaning", icon: "hare.fill", destination: .technique("food-small-game-cleaning")),
                            /* Injected */ TriageOption(id: "orphan-food-6426", label: "Processing (Expanded)", icon: "plus.circle.fill", destination: .techniqueList(["food-acorn-leaching-methods", "food-bone-grease", "food-improvised-flour", "food-ash-caking", "food-salt-extraction", "food-fat-rendering-techniques", "food-rabbit-processing"])), // Added orphan
                            ...
                            /* Injected */ TriageOption(id: "orphan-food-8597", label: "Cooking (Expanded)", icon: "plus.circle.fill", destination: .techniqueList(["food-rock-boiling-cooking", "food-hot-stone-oven", "food-primitive-grill", "food-reflector-oven", "food-rock-oven", "food-tripod-cooking", "food-spit-roasting"]))
                        ])
                    )),
                    ...
                    TriageOption(id: "food-preserve", label: "Preserve for Later", icon: "clock.fill", destination: .nextQuestion(
                        TriageNode(id: "food-preserve-q", question: "How do you want to preserve?", options: [
                            ...
                            /* Injected */ TriageOption(id: "orphan-food-8546", label: "Preservation (Expanded)", icon: "plus.circle.fill", destination: .techniqueList(["food-solar-drying", "food-fish-smoking", "food-natural-refrigeration", "food-smoking-preservation"]))
                        ])
                    ))
                ])
            )),
            ...
            TriageOption(id: "food-adv-trap", label: "Advanced Trapping & Fishing", icon: "target", destination: .nextQuestion(
                TriageNode(id: "food-adv-trap-q", question: "What method?", options: [
                    TriageOption(id: "food-ojibwe", label: "Ojibwe Bird Snare", icon: "bird.fill", destination: .technique("food-bird-snare-ojibwe")),
                            /* Injected */ TriageOption(id: "orphan-food-725", label: "Trapping (Expanded)", icon: "plus.circle.fill", destination: .techniqueList(["food-bird-call-trap", "food-snare-drag-set", "food-deadfall-variations", "food-pit-trap-technique", "food-cordage-snare-sets", "food-box-trap", "food-pit-trap", "food-channel-deadfall"])),
        ...
        TriageNode(id: "shelter-root", question: "What climate/environment are you in?", options: [
                ...
                TriageNode(id: "shelter-temp-time", question: "How much time until dark/storm?", options: [
                    TriageOption(id: "shelter-temp-immediate", label: "Less than 1 Hour", icon: "hourglass.bottomhalf.filled", destination: .nextQuestion(
                        TriageNode(id: "shelter-temp-imm-mat", question: "What do you have?", options: [
                            ...
                            /* Injected */ TriageOption(id: "orphan-shelter-3198", label: "Natural (Expanded)", icon: "plus.circle.fill", destination: .techniqueList(["shelter-rock-overhang-basic", "shelter-coastal-driftwood-adv", "shelter-cave-safety"])),
                        ...
                        TriageNode(id: "shelter-cold-deep-tools", question: "Do you have digging tools?", options: [
                            TriageOption(id: "shelter-cold-shovel", label: "Shovel / Pot", icon: "hammer.fill", destination: .nextQuestion(
                                TriageNode(id: "shelter-cold-shovel-time", question: "How much time do you have?", options: [
                                    TriageOption(id: "shelter-cold-hours", label: "2+ Hours", icon: "clock.fill", destination: .techniqueList(["shelter-quinzhee", "shelter-snow-cave"])),
                            /* Injected */ TriageOption(id: "orphan-shelter-2566", label: "Cold Weather (Expanded)", icon: "plus.circle.fill", destination: .techniqueList(["shelter-thermal-trap", "shelter-kochanski-super", "shelter-improvised-insulation"])), // Added orphan
                ...
                TriageNode(id: "shelter-wet-q", question: "What is the main threat?", options: [
                    ...
                    TriageOption(id: "shelter-wet-night", label: "Sleeping Setup", icon: "bed.double.fill", destination: .nextQuestion(
                        TriageNode(id: "shelter-wet-sleep-q", question: "What bothers you most?", options: [
                            ...
                            /* Injected */ TriageOption(id: "orphan-shelter-8121", label: "Wetlands (Expanded)", icon: "plus.circle.fill", destination: .techniqueList(["shelter-raised-swamp-bed"])),
                            TriageOption(id: "shelter-wet-sleep-bugs", label: "Insects / Creatures", icon: "ant.fill", destination: .technique("shelter-hammock")),
                            /* Injected */ TriageOption(id: "orphan-shelter-8799", label: "Tropical (Expanded)", icon: "plus.circle.fill", destination: .techniqueList(["shelter-bamboo-frame", "shelter-swamp-raised-bed", "shelter-hammock-tarp"])),
            ...
            TriageOption(id: "shelter-urban", label: "Urban / After Disaster", icon: "building.2.fill", destination: .nextQuestion(
                TriageNode(id: "shelter-urban-q", question: "What's your situation?", options: [
                    ...
                    TriageOption(id: "shelter-urban-vehicle", label: "Vehicle Available", icon: "car.fill", destination: .techniqueList(["shelter-vehicle", "shelter-parachute"])),
                            /* Injected */ TriageOption(id: "orphan-shelter-4190", label: "Advanced (Expanded)", icon: "plus.circle.fill", destination: .techniqueList(["shelter-pit-house", "shelter-group-shelter", "shelter-long-term-maintenance", "shelter-solar-heating"])), // Added orphan
            ...
            TriageOption(id: "an-snake", label: "Snake", icon: "scribble.variable", destination: .nextQuestion(
                TriageNode(id: "an-snake-q", question: "Did it bite you?", options: [
                    TriageOption(id: "an-snake-bite", label: "Yes — bitten", icon: "exclamationmark.triangle.fill", destination: .technique("firstaid-snakebite")),
                            /* Injected */ TriageOption(id: "orphan-firstaid-7162", label: "Bites (Expanded)", icon: "plus.circle.fill", destination: .techniqueList(["firstaid-snake-bite-pressure-immobilization", "firstaid-spider-bite-widow", "firstaid-spider-bite-recluse"])),
                ...
                TriageNode(id: "an-env-q", question: "What environment?", options: [
                    ...
                    TriageOption(id: "an-desert", label: "Desert Hazards", icon: "sun.max.fill", destination: .nextQuestion(
                        TriageNode(id: "an-desert-q", question: "What do you need?", options: [
                            ...
                            /* Injected */ TriageOption(id: "orphan-env-5567", label: "Environment (Expanded)", icon: "plus.circle.fill", destination: .techniqueList(["env-tropical-disease-adv"])),
                            /* Injected */ TriageOption(id: "orphan-env-2380", label: "Alpine (Expanded)", icon: "plus.circle.fill", destination: .techniqueList(["env-altitude-acclimatization"])),
                            /* Injected */ TriageOption(id: "orphan-env-5970", label: "Heat (Expanded)", icon: "plus.circle.fill", destination: .techniqueList(["env-heat-exhaustion"])),
                            /* Injected */ TriageOption(id: "orphan-env-7477", label: "Cold (Expanded)", icon: "plus.circle.fill", destination: .techniqueList(["env-hypothermia-stages", "env-arctic-shelter-adv"])),
                            /* Injected */ TriageOption(id: "orphan-env-7912", label: "Wildlife (Expanded)", icon: "plus.circle.fill", destination: .techniqueList(["env-bear-encounter", "env-snake-encounter"])),
                            /* Injected */ TriageOption(id: "orphan-env-9086", label: "Maritime (Expanded)", icon: "plus.circle.fill", destination: .techniqueList(["env-sea-survival-raft", "env-sea-shark-deterrent", "env-sea-seasickness-pressure", "env-sea-raft-repair", "env-sea-water-discipline", "env-sea-barnacles"])),
                            /* Injected */ TriageOption(id: "orphan-env-9984", label: "Desert (Expanded)", icon: "plus.circle.fill", destination: .techniqueList(["env-desert-water-strategy", "env-desert-night-adv", "env-desert-shelter-adv", "env-desert-water-adv"])),
                            /* Injected */ TriageOption(id: "orphan-env-6785", label: "Fire (Expanded)", icon: "plus.circle.fill", destination: .techniqueList(["env-wildfire-escape"])),
                            /* Injected */ TriageOption(id: "orphan-env-1236", label: "Terrain (Expanded)", icon: "plus.circle.fill", destination: .techniqueList(["env-quicksand-escape", "env-river-crossing"])),
                            /* Injected */ TriageOption(id: "orphan-env-2904", label: "disaster (Expanded)", icon: "plus.circle.fill", destination: .techniqueList(["env-tsunami-vertical"])),
                            /* Injected */ TriageOption(id: "orphan-env-8026", label: "alpine (Expanded)", icon: "plus.circle.fill", destination: .techniqueList(["env-avalanche-swim"])),
                            /* Injected */ TriageOption(id: "orphan-env-1280", label: "Hazards (Expanded)", icon: "plus.circle.fill", destination: .techniqueList(["env-mine-shaft-safety"])),
                            /* Injected */ TriageOption(id: "orphan-env-8275", label: "Navigation (Expanded)", icon: "plus.circle.fill", destination: .techniqueList(["env-railroad-navigation"])),
                            /* Injected */ TriageOption(id: "orphan-env-6366", label: "Mountains (Expanded)", icon: "plus.circle.fill", destination: .techniqueList(["env-extreme-altitude"])),
                            /* Injected */ TriageOption(id: "orphan-env-7206", label: "Weather (Expanded)", icon: "plus.circle.fill", destination: .techniqueList(["env-sinkhole-response", "env-mudslide-survival", "env-dust-storm-response", "env-hailstorm-shelter", "env-ice-storm-outage", "env-fog-navigation", "env-cave-flood-response", "env-quicksand-response", "env-wildfire-smoke", "env-lightning-crouch", "env-tornado-field", "env-flood-vertical", "env-flash-flood-adv", "env-post-flood"])),
                    ...
                    TriageOption(id: "an-jungle", label: "Jungle Hazards", icon: "tree.fill", destination: .nextQuestion(
                        TriageNode(id: "an-jungle-q", question: "What do you need?", options: [
                            ...
                            /* Injected */ TriageOption(id: "orphan-env-7149", label: "Jungle (Expanded)", icon: "plus.circle.fill", destination: .techniqueList(["env-jungle-movement-adv", "env-jungle-travel-plan", "env-jungle-shelter-adv", "env-jungle-water-adv"])),
                    ...
                    TriageOption(id: "an-arctic", label: "Arctic Shelter & Survival", icon: "snowflake", destination: .technique("env-arctic-shelter")),
                            /* Injected */ TriageOption(id: "orphan-env-2825", label: "Arctic (Expanded)", icon: "plus.circle.fill", destination: .techniqueList(["env-arctic-movement", "env-ice-fishing", "env-vapor-barrier"]))
                ])
            )),
                ...
                TriageNode(id: "wet-swim-q", question: "Why?", options: [
                    ...
                    TriageOption(id: "wet-drown-rescue", label: "Rescuing Drowning Person", icon: "person.2.fill", destination: .nextQuestion(
                        TriageNode(id: "wet-drown-how", question: "How far away are they?", options: [
                            ...
                            TriageOption(id: "wet-drown-throw", label: "Can Throw Rope / Object", icon: "arrow.right", destination: .techniqueList(["rescue-throw-bag", "rescue-throw-line"])),
                            /* Injected */ TriageOption(id: "orphan-rescue-9214", label: "Water Rescue (Expanded)", icon: "plus.circle.fill", destination: .techniqueList(["rescue-water-dye-marker", "rescue-water-evacuation"])), // Added orphan
                ...
                TriageNode(id: "wet-curr-q", question: "Where?", options: [
                    TriageOption(id: "wet-rip", label: "Ocean Rip Current", icon: "water.waves", destination: .nextQuestion(
                        TriageNode(id: "wet-rip-q", question: "How strong?", options: [
                            ...
                            /* Injected */ TriageOption(id: "orphan-env-4300", label: "Water (Expanded)", icon: "plus.circle.fill", destination: .techniqueList(["env-rip-current-escape", "env-cold-water-immersion", "env-ocean-adrift", "env-coastal-tidal-adv"])),
                    ...
                    TriageOption(id: "wet-river", label: "River Current", icon: "arrow.right", destination: .nextQuestion(
                        TriageNode(id: "wet-river-q", question: "What's ahead?", options: [
                            ...
                            TriageOption(id: "wet-river-calm", label: "Current but No Rapids", icon: "water.waves", destination: .techniqueList(["rescue-river-self", "nav-river-navigation"])),
                            /* Injected */ TriageOption(id: "orphan-nav-8418", label: "Basic (Expanded)", icon: "plus.circle.fill", destination: .techniqueList(["nav-back-bearing-check"])), // Added orphan
            ...
            TriageOption(id: "wet-signal-adv", label: "Advanced Signaling", icon: "antenna.radiowaves.left.and.right", destination: .nextQuestion(
                TriageNode(id: "wet-sig-q", question: "What signaling method?", options: [
                    ...
                    TriageOption(id: "wet-sig-heli", label: "Helicopter Approaching", icon: "helicopter", destination: .techniqueList(["rescue-helicopter", "rescue-helicopter-approach"])),
                            /* Injected */ TriageOption(id: "orphan-rescue-5486", label: "Aircraft Rescue (Expanded)", icon: "plus.circle.fill", destination: .techniqueList(["rescue-heli-lz-prep"])),
                    ...
                    TriageOption(id: "wet-sig-panel", label: "Signal Panel", icon: "square.fill", destination: .technique("rescue-signal-panel")),
                            /* Injected */ TriageOption(id: "orphan-rescue-7905", label: "Visual Signaling (Expanded)", icon: "plus.circle.fill", destination: .techniqueList(["rescue-vehicle-signal-alt", "rescue-reflective-signal", "rescue-clothing-signals"])),
            ...
            TriageOption(id: "human-active", label: "Active Attacker / Pursuer", icon: "figure.run", destination: .nextQuestion(
                TriageNode(id: "human-active-q", question: "Can you escape?", options: [
                    TriageOption(id: "human-run", label: "Yes — Run / Evade", icon: "figure.run", destination: .technique("psych-evasion")),
                            /* Injected */ TriageOption(id: "orphan-psych-4", label: "Security (Expanded)", icon: "plus.circle.fill", destination: .techniqueList(["psych-deescalation"])),
