...
extension ContentDatabase {
    ...
    func buildAnimalTriage() -> TriageNode {
        TriageNode(id: "animal-root", question: "What animal?", options: [
            ...
            TriageOption(id: "g1", label: "Animal Encounters", icon: "pawprint.fill", destination: .nextQuestion(
                TriageNode(id: "g1-q", question: "What specifically?", options: [
                TriageOption(id: "g2", label: "Species", icon: "cross.case.fill", destination: .nextQuestion(
                    TriageNode(id: "g2-q", question: "Select:", options: [
                        TriageOption(id: "g3", label: "Defensive vs. Predatory behavior analysis", icon: "pawprint.fill", destination: .technique("env-bear-defense-advanced")),
                        TriageOption(id: "g4", label: "Surviving a close encounter with black or grizzly bears", icon: "pawprint.fill", destination: .technique("env-bear-encounter"))
                    ])
                )),
                TriageOption(id: "g5", label: "Snake", icon: "ant.fill", destination: .nextQuestion(
                    TriageNode(id: "g5-q", question: "Select:", options: [
                        TriageOption(id: "g6", label: "Avoid bites through behavior modification", icon: "ant.fill", destination: .technique("env-snake-avoidance")),
                        TriageOption(id: "g7", label: "Avoiding snakebite and managing envenomation", icon: "ant.fill", destination: .technique("env-snake-encounter"))
                    ])
                )),
                TriageOption(id: "g8", label: "Encounters", icon: "cross.case.fill", destination: .nextQuestion(
                    TriageNode(id: "g8-q", question: "Select:", options: [
                        TriageOption(id: "g9", label: "Intimidation and dominance assertion", icon: "cross.case.fill", destination: .technique("env-mountain-lion-defense")),
                        TriageOption(id: "g10", label: "Reduce spider encounters in your living area", icon: "ant.fill", destination: .technique("env-spider-avoidance"))
                    ])
                )),
                TriageOption(id: "g11", label: "Safety", icon: "cross.case.fill", destination: .nextQuestion(
                    TriageNode(id: "g11-q", question: "Select:", options: [
                        TriageOption(id: "g12", label: "Survive in crocodilian habitat", icon: "cross.case.fill", destination: .technique("env-crocodile-territory")),
                        TriageOption(id: "g13", label: "Most dangerous large animal in North America by injury ", icon: "pawprint.fill", destination: .technique("env-moose-encounter"))
                    ])
                )),
                TriageOption(id: "g14", label: "Mass", icon: "cross.case.fill", destination: .nextQuestion(
                    TriageNode(id: "g14-q", question: "Select:", options: [
                        TriageOption(id: "g15", label: "Manage mass fire ant envenomation — thousands of simult", icon: "ant.fill", destination: .technique("env-ant-attack-fire")),
                        TriageOption(id: "g16", label: "Prevent mass stinging events in camp and on trail", icon: "ant.fill", destination: .technique("env-wasp-nest-avoidance"))
                    ])
                ))
                ])
            )),
